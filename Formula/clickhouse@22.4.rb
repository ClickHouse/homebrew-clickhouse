class ClickhouseAT224 < Formula
  ...
  bottle do
    root_url "https://github.com/Altinity/homebrew-clickhouse/releases/download/clickhouse@22.4-22.4.6.53"
